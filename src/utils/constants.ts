...
export const ABOUT_CONTENT =
  "Welcome to HackerStat! Our objective with this site is to provide a place for Devs/Designers to show off their work and engagement with the coding community. The current integrations that devs/designers can show off are GitHub, NPM, StackOverflow, Twitter, and WakaTime so far! For Tech Recruiters, we take user integration verification very seriously. If someone is displaying a GitHub as their's, they will have to sign into their GitHub account via OAuth Account.";
...
export const PRIVACY_INTERPRETATION =
  'The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.';

export const PRIVACY_DEFINITIONS = [
  ['Account', 'means a unique account created for You to access our Service or parts of our Service.'],
  ['Company', 'referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to HackerStats.'],
  [
    'Cookies',
  ...
  ['Website', 'refers to HackerStats, accessible from', 'https://hackerstats.io'],
  [
    'You',
...
export const PRIVACY_PERSONAL_DATA =
  'While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:';

export const PRIVACY_PERSONAL_DATA_ITEMS = [
  'Email address',
...
export const PRIVACY_USAGE_DATA = `Usage Data is collected automatically when using the Service.
...
export const PRIVACY_TECH_AND_COOKIES = [
  [
  ...
  [
    'Flash Cookies.',
    'Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read "Where can I change the settings for disabling, or deleting local shared objects?" available at https://adobe.ly/3ymIryO',
  ],
  [
    'Web Beacons.',
...
export const TRACKING_TECHNOLOGIES_AND_COOKIES_PURPOSES = [
  [
...
export const USE_OF_YOUR_PRIVATE_DATA = [
...
export const USE_OF_YOUR_PRIVATE_DATA_PT2 = [
  [
...
export const RENTENTION_OF_YOUR_DATA = [
...
export const TRACKING_TECHNOLOGIES_AND_COOKIES = [
...
export const TRANSFER_OF_YOUR_PERSONAL_DATA = [
...
export const DISCLOSURE_OF_YOUR_PERSONAL_DATA = [
...
export const CHILDRENS_PRIVACY = [
...
export const LINKS_TO_OTHER_WEBSITES = [
  "Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.",
  'We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.',
];

export const CHANGES_TO_THIS_PRIVACY_POLICY = [
