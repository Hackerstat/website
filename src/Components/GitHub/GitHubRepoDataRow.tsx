...
import { GitHubRepoDisplayDataType } from '../../utils/utils';

export const GitHubRepoDataRow = ({ repos }: { repos: Array<GitHubRepoDisplayDataType> }): JSX.Element => {
  return (
    <Stack direction="column" mt={2} spacing="24px">
      {repos.map((repo) => (
        <Box m="0 auto" borderRadius={10} p={3} border="1px solid white" w="90%" key={`${repo.url}`}>
